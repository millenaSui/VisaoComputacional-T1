...
A aplicação foi projetada para receber imagens comuns, padronizá-las para um formato específico (dimensão 512x512 em *grayscale*), extrair informações avançadas sobre seus padrões visuais (texturas) por meio de filtros matemáticos e, em seguida, agrupar áreas semelhantes da imagem usando a técnica de distância euclidiana.
...
- **Segmentação:** As características sofrem uma normalização estatística, aplica-se distância euclidiana para dividir blocos em 4 grupos e cada bloco recebe um rótulo (indicando a qual dos 4 padrões de textura pertencem)
